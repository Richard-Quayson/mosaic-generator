...
class Mosaic:
    ...
    def __init__(self, colour_list=None, num_rows: int = None, num_columns: int = None) -> None:
        ...
        NOTE: When creating a Mosaic object instance, you must either provide a colour list
        or the number of rows and columns for the mosaic image.
        ...
        if not colour_list:
            if num_rows and num_columns:
                self.rows = num_rows
                self.columns = num_columns
            else:
                print("Please provide a colour list or the number of rows and columns for the mosaic image!")
                exit(1)
        else:
